function Footer() {
  return (
    <footer className="bg-success">
      <div className="fs-1 container border">
        Footer chunks as necessary, making this the first true generator on the
        ...
        from repetition, injected humour, or non-characteristic words etc. There
