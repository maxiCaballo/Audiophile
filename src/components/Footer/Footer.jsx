...
function Footer() {
  return (
    <FooterComponent style={{ backgroundColor: "var(--color6)" }}>
        ...
        <div>
          ...
          <nav>
            <ul>
              ...
              <li>
                <NavbarLink to="/">HEADPHONES</NavbarLink>
              </li>
              <li>
                <NavbarLink to="/">SPEAKERS</NavbarLink>
              </li>
              <li>
                <NavbarLink to="/">EARPHONES</NavbarLink>
              </li>
            </ul>
          </nav>
        </div>
